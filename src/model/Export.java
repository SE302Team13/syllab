...
public class Export {
	...
	public void export(Course course, String path) {
		...
		String isFall = course.getSemester() == SemesterOptions.FALL || course.getSemester() == SemesterOptions.BOTH
				? "X"
				: "";
		String isSpring = course.getSemester() == SemesterOptions.SPRING || course.getSemester() == SemesterOptions.BOTH
				? "X"
				: "";
		c.set("fall", isFall);
