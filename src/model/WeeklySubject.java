...
public class WeeklySubject implements Serializable {
	...
	/**
	 * General constructor for {@link WeeklySubject} class. <b>Do not</b> use this
	 * constructor. To get the default {@link WeeklySubject} set for a course use
	 * {@link #createDefaultSemester()} method.
	 * 
	 * It's given for further development and should not to be used without proper
	 * control of the input values. Uncontrolled use of this constructor may
	 * <b>violate</b> the consistency of the program.
	 * 
	...
	/**
	 * Combined method for setDescription() and setRelatedMaterial(). It updates the
	 * subject with new values.
	 * 
	 * @param description New description for the {@code WeeklySubject}.
	 * @param rm          New related material for the {@code WeeklySubject}.
	 * @return {@code true} if the change is valid to be applied and change is
	 *         applied, return false {@code false} if the change is not valid to be
	 *         applied.
	 */
	...
	/**
	 * Create a semester schedule with 16 weeks. Default option. This method will be
	 * used to create a default {@link Course} object.
	 * 
