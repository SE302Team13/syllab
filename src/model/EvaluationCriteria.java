...
public class EvaluationCriteria implements Serializable {
	...
	//Constructor(s)
	/**
	 * General constructor for the {@link EvaluationCriteria} class. It requires mandatory fields
	 * and <b>does not</b> have a validation mechanism for values. So <b>make sure</b> the values validated
	 * before pass it to this constructor.  
	 ...
	 * @param values Contribution levels to learning outcomes related with this criteria.
	 */
	...
	/*
	 * NOTE
	 * This setter should not be accessed directly. Contribution levels are deeply connected with
	 * course class fields. Thus a change should not be done directly from EvaluationCriteria object.
	 * author: Hakan Ayaz
	 * date: 02.01.2021 / 16.42
	 */
	
	/*
	public boolean setContributionLevels(ArrayList<Integer> contributionLevels) {
		if (contributionLevels != null) {
